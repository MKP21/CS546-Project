...
//add users
    try{
        ...
        var roomss = await user.getUserByEmail('ms@dundermifflin.com');
        ...
        var deleted = await user.deleteUser(roomss._id);

        var edituser = await user.getUserByEmail('ds@dundermifflin.com');
